  ...
  return (Store<AppState> store) async {
    try {
      ...
      if (Platform.isAndroid) {
        directory =
            Directory(keybackupLocation.isEmpty ? Values.ANDROID_DEFAULT_DIRECTORY : keybackupLocation);
      ...
      store.dispatch(addAlert(
        error: error,
        origin: 'exportSessionKeys',
        message: 'Failed to backup your current session keys, contact us at https://syphon.org/support',
      ));
    } finally {
