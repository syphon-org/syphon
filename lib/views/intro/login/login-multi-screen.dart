...
class MultiLoginScreen extends StatefulWidget {
  ...
  const MultiLoginScreen({Key? key, this.store}) : super(key: key);

  @override
  MultiLoginState createState() => MultiLoginState();
}

class MultiLoginState extends State<MultiLoginScreen> {
