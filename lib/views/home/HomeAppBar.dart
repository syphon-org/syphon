...
class AppBarHome extends HookWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final offline = useSelectorUnsafe<AppState, bool>(
      (state) => state.syncStore.offline,
    );
    final syncing = useSelectorUnsafe<AppState, bool>(
      (state) => selectSyncingStatus(state),
    );
    final unauthed = useSelectorUnsafe<AppState, bool>(
    ...
    final currentUser = useSelectorUnsafe<AppState, User>(
