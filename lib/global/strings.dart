...
class Strings {
  ...
  static final titleProxyUseBasicAuthentication =
      tr('title-proxy-use-basic-authentication');
  ...
  static final titleSendMediaMessageUnencrypted =
      tr('title-send-media-message-unencrypted');
  ...
  static final titleDialogKeyBackupWarning =
      tr('title-dialog-key-backup-warning');
  ...
  static final titleDialogConfirmDeactivateAccount =
      tr('title-dialog-confirm-deactivate-account');
  static final titleDialogConfirmDeactivateAccountFinal =
      tr('title-dialog-confirm-deactivate-account-final');
  static final titleDialogBackupSessionKeys =
      tr('title-dialog-backup-session-keys');
  static final titleDialogRemoveScreenLock =
      tr('title-dialog-remove-screen-lock');
  static final titleDialogEnterScreenLockPin =
      tr('title-dialog-enter-screen-lock-pin');
  static final titleDialogEnterNewScreenLockPin =
  ...
  static final subtitleProxyUseBasicAuthentication =
      tr('subtitle-proxy-use-basic-authentication');
  ...
  static final subtitleShowMembershipEvents =
      tr('subtitle-settings-show-membership-events');
  ...
  static final subtitleDismissKeyboard =
      tr('subtitle-settings-dismiss-keyboard');
  static final subtitleViewUploadedMedia =
      tr('subtitle-settings-view-uploaded-media');
  static final subtitleImagesAudioVideoFiles =
      tr('subtitle-images-audio-video-files');
  static String subtitleThemeSettings(String? theme, String? font) =>
      tr('subtitle-theme-settings', args: ['$theme', '$font']);
  static String subtitlePrivacySettings(
          String? screenLock, String? registrationLock) =>
      tr('subtitle-privacy-settings',
          args: ['$screenLock', '$registrationLock']);
  ...
  static final listItemSettingsProxyUsername =
      tr('list-item-settings-proxy-username');
  static final listItemSettingsProxyPassword =
      tr('list-item-settings-proxy-password');
  static final listItemSettingsSyncInterval =
  ...
  static final listItemSettingsEnterSends =
      tr('list-item-settings-enter-sends');
  static final listItemSettings24hFormat = tr('list-item-settings-24h-format');
  static final listItemSettingsDismissKeyboard =
      tr('list-item-settings-dismiss-keyboard');
  ...
  static final listItemSettingsViewUploadedMedia =
      tr('list-item-settings-view-uploaded-media');
  static final listItemSettingsAutoDownload =
      tr('list-item-settings-auto-download');
  static final listItemSettingsWhenUsingMobileData =
      tr('list-item-settings-when-using-mobile-data');
  static final listItemSettingsWhenUsingWiFi =
      tr('list-item-settings-when-using-wi-fi');
  static final listItemSettingsWhenRoaming =
      tr('list-item-settings-when-roaming');

  static final listItemSettingsManualSync =
      tr('list-item-settings-manual-sync');
  static final listItemSettingsForceFullSync =
      tr('list-item-settings-force-full-sync');

  static String listItemUserDetailsStartChat(String? name) =>
      tr('list-item-user-details-start-chat', args: ['$name']);
  static final listItemUserDetailsRoomInvite =
      tr('list-item-user-details-invite-to-room');
  static final listItemUserDetailsSendMessage =
      tr('list-item-user-details-send-message');
  static final listItemUserDetailsViewProfile =
      tr('list-item-user-details-view-profile');
  static final listItemUserDetailsUnblockUser =
      tr('list-item-user-details-unblock-user');
  static final listItemUserDetailsBlockUser =
      tr('list-item-user-details-block-user');

  static final listItemImageOptionsPhotoSelectMethod =
      tr('list-item-image-options-photo-select-method');
  static final listItemImageOptionsTakePhoto =
      tr('list-item-image-options-take-photo');
  static final listItemImageOptionsPickFromGallery =
      tr('list-item-image-options-pick-from-gallery');
  static final listItemImageOptionsRemovePhoto =
      tr('list-item-image-options-remove-photo');
  ...
  static final listItemContextSwitcherAccounts =
      tr('list-item-context-switcher-accounts');
  static final listItemContextSwitcherAddAccount =
      tr('list-item-context-switcher-add-account');

  static final listItemAdvancedSettingsLicenses =
      tr('list-item-advanced-settings-licenses');
  ...
  static final listItemChatDetailToggleDirectChat =
  ...
  static final listItemChatDetailNotifications =
      tr('list-item-chat-detail-notifications');
  static final listItemChatDetailVibrate = tr('list-item-chat-detail-vibrate');
  static final listItemChatDetailNotificationSound =
      tr('list-item-chat-detail-notification-sound');
  ...
  static final buttonTextConfirmDeleteKeys =
      tr('button-text-confirm-delete-keys');
  ...
  static final placeholderDefaultRoomNotification =
      tr('label-default-room-notification');
  ...
  static final alertStorageAccessRequiredForKeys =
      tr('alert-storage-access-required-for-keys');
  static final alertWaitForFullSync =
      tr('alert-wait-for-full-sync-before-switching');
  static final alertLogOutToEnableMultiaccounts =
      tr('alert-log-out-enable-multiaccount');
  ...
  static final contentNotificationStyleTypeInbox =
      tr('content-notification-style-type-inbox');
  static final contentNotificationStyleTypeLatest =
      tr('content-notification-style-type-latest');
  ...
  static final contentLogoutMultiaccountConfirm =
      tr('content-logout-multiaccount-confirm');
  ...
  static String confirmLinkout(String url) =>
      tr('confirm-linkout', args: [url]);
  ...
  static String confirmLeaveRooms({required Iterable<Room> rooms}) {
    ...
    var s = tr(
      ...
      args: [
        if (rooms.length == 1) '${rooms.first.name}' else '${rooms.length}'
      ],
    );
