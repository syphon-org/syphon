...
class Strings {
  ...
  // Titles (Dialogs)
  static final titleDialogRemoteUpdate = tr('title-dialog-remote-update');
  ...
  static final listItemAdvancedSettingsCheckForUpdates = tr('list-item-advanced-settings-check-for-updates');
  ...
  // Content (Dialogs)
  static String contentDialogRemoteUpdate(String? version) =>
      tr('content-dialog-remote-update', args: ['$version']);
